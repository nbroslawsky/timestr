var INTERVALS = [
	{ match: /^\s*(\d+)\s*(w)(?:(?:ee)?ks?)?\s*$/i, ms: 604800000 },
	{ match: /^\s*(\d+)\s*(d)(?:ays?)?\s*$/i, ms: 86400000 },
	{ match: /^\s*(\d+)\s*(h)(?:(?:ou)?rs?)?\s*$/i, ms: 3600000 },
	{ match: /^\s*(\d+)\s*(m)(?:in(?:ute)?s?)?\s*$/i, ms: 60000 },
	{ match: /^\s*(\d+)\s*(s)(?:ec(?:ond)?s?)?\s*$/i, ms: 1000 },
	{ match: /^\s*(\d+)\s*(?:ms|milliseconds?)?\s*$/i, ms: 1 }
];
